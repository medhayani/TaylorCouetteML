...
def main():
    ...
    items = build_dataset(
        ROOT / "data" / "combined_data_trainval.csv",          # leak-free: training and validation elasticities only
        ROOT / "data" / "branch_functional_descriptors_leakfree_trainval.csv",
        ROOT / "data" / "ensemble_median_targets_lf.npz",   # median of the 29 leak-free teachers
    )
